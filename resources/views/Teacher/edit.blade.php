            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="form-control custom-input" value="{{ $teacher->name }}">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="date" name="dob" class="form-control custom-input" value="{{ $teacher->dob }}">
                    </div>
...
{{--
                    ...
                    <div class="col-md-6 mt-3">
                        ...
                        <div class="thumbnail-preview" onclick="document.getElementById('image').click()">
                            ...
                            <img id="previewImg" src="{{ $teacher->image ? asset('storage/' . $teacher->image) : '' }}"
