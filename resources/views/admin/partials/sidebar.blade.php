<aside class="main-sidebar sidebar-dark-primary sidebar-fixed">
    ...
    <a href="{{ route('dashboard') }}" class="brand-link shadow-sm"
        ...
        <img src="[cdn-icons-png.flaticon.com](https://cdn-icons-png.flaticon.com/512/3135/3135755.png)"
        ...
        <nav>
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="[via.placeholder.com](https://via.placeholder.com/40)" class="img-circle">
                    </div>
                    <div class="info">
