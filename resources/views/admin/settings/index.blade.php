                ...
                <div class="tab-content" id="custom-tabs-four-tabContent">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">This will be displayed in sidebar (e.g., "HotelMIS",
                                        "Admin Panel")</small>
                                    @error('app_name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="primary_font" name="primary_font">
                                        <option value="Inter"
                                            {{ old('primary_font', $settings['primary_font'] ?? 'Inter') == 'Inter' ? 'selected' : '' }}>
                                            Inter (Modern Sans-serif)
                                        </option>
                                        <option value="Roboto"
                                            {{ old('primary_font', $settings['primary_font'] ?? '') == 'Roboto' ? 'selected' : '' }}>
                                            Roboto
                                        </option>
                                        <option value="Open Sans"
                                            {{ old('primary_font', $settings['primary_font'] ?? '') == 'Open Sans' ? 'selected' : '' }}>
                                            Open Sans
                                        </option>
                                        <option value="Lato"
                                            {{ old('primary_font', $settings['primary_font'] ?? '') == 'Lato' ? 'selected' : '' }}>
                                            Lato
                                        </option>
                                        <option value="Poppins"
                                            {{ old('primary_font', $settings['primary_font'] ?? '') == 'Poppins' ? 'selected' : '' }}>
                                            Poppins
                                        </option>
                                        <option value="Montserrat"
                                            {{ old('primary_font', $settings['primary_font'] ?? '') == 'Montserrat' ? 'selected' : '' }}>
                                            Montserrat
                                        </option>
                                        <option value="Playfair Display"
                                            {{ old('primary_font', $settings['primary_font'] ?? '') == 'Playfair Display' ? 'selected' : '' }}>
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="khmer_font" name="khmer_font">
                                        ...
                                        <option value="hanuman"
                                            {{ old('khmer_font', $settings['khmer_font'] ?? '') == 'hanuman' ? 'selected' : '' }}>
                                            Hanuman
                                        </option>
                                        <option value="kantumruy"
                                            {{ old('khmer_font', $settings['khmer_font'] ?? '') == 'kantumruy' ? 'selected' : '' }}>
                                            Kantumruy Pro
                                        </option>
                                    </select>
                                    <small class="form-text text-muted">
                            ...
                            <div class="col-md-6">
                                <div class="card bg-light mt-4">
                                    <div class="card-body p-3">
                                        <p class="mb-2"><strong>Font Preview:</strong></p>
                                        <div id="font-preview-hanuman"
                                            style="font-family: 'Hanuman', sans-serif; font-size: 18px; display: none;">
                                            ជំរាបសួរ - សណ្ឋាគារបណ្តាក់អា រាច (Hanuman)
                                        </div>
                                        <div id="font-preview-kantumruy"
                                            style="font-family: 'Kantumruy Pro', sans-serif; font-size: 18px; display: none;">
                    ...
                    <div class="tab-pane fade" id="payment" role="tabpanel">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    <i class="fas fa-info-circle"></i> Configure your payment gateways here. These settings
                                    will be used to process payments on the guest portal.
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body" style="display: none;">
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        ...
                                        <label class="custom-control-label" for="paypal_enabled">Enable PayPal
                                            Payment</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="paypal_mode" name="paypal_mode">
                                        <option value="sandbox"
                                            ...
                                            Sandbox (Test)</option>
                                        <option value="live"
                                            {{ isset($settings['paypal_mode']) && $settings['paypal_mode'] == 'live' ? 'selected' : '' }}>
                        ...
                        <div class="card card-outline card-danger collapsed-card">
                            ...
                            <div class="card-body" style="display: none;">
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="khqr_enabled"
                                            name="khqr_enabled"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="khqr_merchant_name"
                                                name="khqr_merchant_name"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="khqr_merchant_city"
                                                name="khqr_merchant_city"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="khqr_merchant_id"
                                        name="khqr_merchant_id" value="{{ $settings['khqr_merchant_id'] ?? '' }}">
                                </div>
                                <div class="form-group">
                                    <label for="khqr_bakong_account_id">Bakong Account ID</label>
                                    <input type="text" class="form-control" id="khqr_bakong_account_id"
                                        name="khqr_bakong_account_id"
                        ...
                        <div class="card card-outline card-navy collapsed-card">
                            ...
                            <div class="card-body" style="display: none;">
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        <input type="checkbox" class="custom-control-input" id="acleda_enabled"
                                            name="acleda_enabled"
                                            {{ isset($settings['acleda_enabled']) && $settings['acleda_enabled'] == '1' ? 'checked' : '' }}>
                                        <label class="custom-control-label" for="acleda_enabled">Enable ACLEDA
                                            Payment</label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="acleda_base_url">API Base URL</label>
                                    <input type="text" class="form-control" id="acleda_base_url"
                                        name="acleda_base_url" value="{{ $settings['acleda_base_url'] ?? '' }}">
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="acleda_login_id">Login ID</label>
                                            <input type="text" class="form-control" id="acleda_login_id"
                                                name="acleda_login_id" value="{{ $settings['acleda_login_id'] ?? '' }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="acleda_password">Password</label>
                                            <input type="password" class="form-control" id="acleda_password"
                                                name="acleda_password" value="{{ $settings['acleda_password'] ?? '' }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="acleda_merchant_id">Merchant ID</label>
                                    <input type="text" class="form-control" id="acleda_merchant_id"
                                        name="acleda_merchant_id" value="{{ $settings['acleda_merchant_id'] ?? '' }}">
                                </div>
                                <div class="form-group">
                            ...
                            <div class="card-body" style="display: none;">
                                <div class="form-group">
                                    <div class="custom-control custom-switch">
                                        ...
                                        <label class="custom-control-label" for="stripe_enabled">Enable Stripe
                                            Payment</label>
                                    </div>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="tab-pane fade" id="about" role="tabpanel">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">Describe your hotel, facilities, and services. You can add
                                images, formatting, and more.</small>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="contact" role="tabpanel">
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">Add additional contact information, office hours, or any
                                other details. You can add images and rich formatting.</small>
                        </div>
                        <div class="form-group">
        ...
        $(document).ready(function() {
            ...
            function validateImageFile(file, allowedTypes, maxMB) {
                ...
                if (maxMB && file.size > (maxMB * 1024 * 1024)) {
                    return {
                        ok: false,
                        msg: "File too large: " + bytesToMB(file.size) + "MB (max " + maxMB + "MB)"
                    };
                }
                return {
                    ok: true,
            ...
            function showPreview(input, previewId, defaultText) {
                ...
                reader.onload = function(e) {
                    $preview.html(
                        ...
                        '<div class="small text-muted mt-1">Type: ' + file.type + ' | Size: ' + bytesToMB(
                            file.size) + 'MB</div>' +
                        '</div>'
                    );
                };
            ...
            $('#favicon').on('change', function() {
                ...
                const valid = validateImageFile(
                    file,
                    ['image/png', 'image/x-icon', 'image/vnd.microsoft.icon', 'image/jpeg', 'image/jpg',
                        'image/webp'
                    ],
                    2
                );
